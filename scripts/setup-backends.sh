...
print_banner() {
    ...
    echo "╔══════════════════════════════════════════════════════════╗"
    echo "║                                                          ║"
    echo "║       ${BOLD}Gen Serving Gateway - Backend Setup${NC}${CYAN}              ║"
    echo "║                                                          ║"
    echo "║   Configure AI model backends for image & text          ║"
...
try:
    ...
    # Image backends
    print("\n  \033[1;35m📷 Image Generation Backends:\033[0m")
    ...
    # Text backends
    print("\n  \033[1;35m💬 Text Generation Backends:\033[0m")
    ...
    if backends.get('grpc'):
        print("\n  \033[1;35m🔌 gRPC Backends:\033[0m")
...
for category in ['image', 'text', 'grpc']:
    ...
    for b in backends[category]:
        ...
        if success:
            print(f"    ✅ {b['name']}: OK ({result})")
        else:
            print(f"    ❌ {b['name']}: FAILED ({result})")
